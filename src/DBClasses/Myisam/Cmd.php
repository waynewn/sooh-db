...
class Cmd
{
    /**
     * 
     * @var \Sooh\DBClasses\Interfaces\Conn
     */
    public $connection;
    public function connect()
    {
        ...
        if(!$this->connection->connected){
            try{
                ...
                throw new \Sooh\DBClasses\DBErr(\Sooh\DBClasses\DBErr::connectError, $e->getMessage()." when try connect to {$this->connection->server} by {$this->connection->user}", "");
            }
        }
    }
    ...
    protected function chkError($stepErrorId=null)
    {
        ...
        if ($errno) {
            ...
            switch ($errno){
                case 1054:$err=\Sooh\DBClasses\DBErr::fieldNotExists;break;
                case 1045:$err=\Sooh\DBClasses\DBErr::connectError;break;
                case 1049:$err=\Sooh\DBClasses\DBErr::connectError;break;
                	
                case 1050:$err=\Sooh\DBClasses\DBErr::tableExists;break;
                case 1146:$err=\Sooh\DBClasses\DBErr::tableNotExists;break;
                case 1060:$err=\Sooh\DBClasses\DBErr::fieldExists;break;
                case 1062:
                case 1022:
                case 1069:
                    ...
                    $err=\Sooh\DBClasses\DBErr::duplicateKey;
                    break;
                default:$err=\Sooh\DBClasses\DBErr::otherError; break;
            }
            $ex=new \Sooh\DBClasses\DBErr($err,'['.$errno.']'.$message, $this->_lastCmd);
            if(!empty($dupKey)){
