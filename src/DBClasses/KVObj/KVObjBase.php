<?php
namespace Sooh\DBClasses\KVObj;
class KVObjBase
{
    /**
   ...
   /**
          ...
          //  error_log("kvobjloaded $tb :".\Sooh2\Util::toJsonSimple($this->r));
           ...
           //     error_log("kvobjloaded 1 :".\Sooh2\Util::toJsonSimple($this->r));
                if($this->field_locker!==null){
                    $this->_lock = \Sooh\DBClasses\LockInfo::factory($this->r[$this->field_locker]);
    ...
    {
        if($this->field_locker===null || $this->_lock->status==\Sooh\DBClasses\LockInfo::status_locked){
    ...
    public function unlock()
    {
        ...
        $this->_lock->status=\Sooh\DBClasses\LockInfo::status_unlock;
